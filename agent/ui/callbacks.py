...
def update_document_on_run_selection(selected_run_path: str) -> Tuple:
    ...
    # Optional dataset profile (generated by agent/extract_context.ipynb)
    dataset_profile = load_dataset_profile(run_dir)
    if isinstance(dataset_profile, dict):
        run_context["dataset_profile"] = dataset_profile
